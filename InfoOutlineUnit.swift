...
extension InfoOutlineUnit {
    struct Input:Identifiable {
        ...
        static let aepActivity = Input(title: "Activity (activity log) represents the bubble's usage over time. Activity is made up of entries. Each entry contains one or more start-pause pairs", image: "bubbleActivity", footnote: "To view a bubble's activity *\(Image.tap) Tap* either the hours or minutes area")
