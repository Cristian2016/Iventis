...
extension InfoOutlineUnit {
    struct Input:Identifiable {
        ...
        static let aepActivity = Input(title: "A bubble's activity (activity log) represents the usage of that bubble over time", image: "bubbleActivity", footnote: "*\(Image.tap) Tap* a bubble's hours or minutes area to view its activity")
    }
}
