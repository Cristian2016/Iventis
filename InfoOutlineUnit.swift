...
extension InfoOutlineUnit {
    struct Input:Identifiable {
        ...
        static let aepActivity = Input(title: "Activity (activity log) represents a bubble's usage over time. Activity groups entries together and each entry has at least one start-pause pair", image: "bubbleActivity", footnote: "To view a bubble's activity *\(Image.tap) Tap* either its hours or minutes area")
