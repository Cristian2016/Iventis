...
extension InfoOutlineUnit {
    struct Input:Identifiable {
        ...
        static let aepActivity = Input(title: "A bubble's activity (activity log) represents its usage over time. Activity is made up of entries and each entry has at least one start-pause pair", image: "bubbleActivity", footnote: "To view a bubble's activity *\(Image.tap) Tap* either its hours or minutes area")
        ...
        static let aepActivityEntryPair = Input(title: "", image: "bubble.activity", imageHeight: 240)
    }
}
