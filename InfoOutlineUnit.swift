...
extension InfoOutlineUnit {
    struct Input:Identifiable {
        ...
        static let aepActivity = Input(title: "A bubble's activity (activity log) represents its usage over time. The activity is made up of entries", image: "bubbleActivity", footnote: "To view a bubble's activity *\(Image.tap) Tap* either its hours or minutes area")
        ...
        static let aepActivityEntryPair = Input(title: "", image: "bubble.activity")
    }
}
