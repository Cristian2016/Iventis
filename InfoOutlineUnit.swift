...
extension InfoOutlineUnit {
    struct Input:Identifiable {
        ...
        static let aepActivity = Input(title: "The activity (activity log) represents the usage of a bubble over time. To view a bubble's activity *\(Image.tap) Tap* either minutes or hours area", image: "bubbleActivity")
    }
}
