...
extension InfoUnit {
    struct Input {
        ...
        static let createTimer = Input(keyword: "Create Timer", symbol: "hand.tap.fill", gesture: "Tap", footnote: "creates timer if \(Image.init(systemName: "checkmark.circle.fill")) shows")
    }
}
